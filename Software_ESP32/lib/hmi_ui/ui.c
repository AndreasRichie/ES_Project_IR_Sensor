...
lv_obj_t * ui_LabelOk;
lv_obj_t * ui_ButtonAll;
lv_obj_t * ui_LabelAll;
lv_obj_t * ui_Image6;
...
lv_obj_t * ui_UnitAH;
lv_obj_t * ui_MRTText;
lv_obj_t * ui_MRTDisplay;
lv_obj_t * ui_ValueMRT;
lv_obj_t * ui_UnitMRT;
...
lv_obj_t * ui_PanelPopUp;
lv_obj_t * ui_LabelCalibration;
lv_obj_t * ui_CalibOption;
lv_obj_t * ui_ValueCalib;
lv_obj_t * ui_ValueNumpad;
...
void ui_event_HoursSlider(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_VALUE_CHANGED) {
        _ui_arc_set_text_value(ui_HoursText, target, "", "");
    }
}
void ui_event_MinutesSlider(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_VALUE_CHANGED) {
        _ui_arc_set_text_value(ui_MinutesText, target, "", "");
    }
}
