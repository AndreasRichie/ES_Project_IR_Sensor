...
esp_err_t esp_lcd_new_panel_st7796(
  ...
  ESP_GOTO_ON_FALSE(st7796, ESP_ERR_NO_MEM, err, TAG,
...
static const lcd_init_cmd_t vendor_specific_init[] = {
    ...
    {0xe0,
     ...
     14},
    {0xe1,
     {0xf0, 0x09, 0x0b, 0x06, 0x04, 0x03, 0x2d, 0x43, 0x42, 0x3b, 0x16, 0x14,
      0x17, 0x1b},
     14},
    {0xf0, {0x3c}, 1},
    {0xf0, {0x69}, 1},
    ...
    // {0x62, {0x38, 0x0D, 0x71, 0xED, 0x70, 0x70, 0x38, 0x0F, 0x71, 0xEF, 0x70,
    // 0x70}, 12},
    // {0x63, {0x38, 0x11, 0x71, 0xF1, 0x70, 0x70, 0x38, 0x13, 0x71, 0xF3, 0x70,
    // 0x70}, 12},
...
static esp_err_t panel_st7796_mirror(esp_lcd_panel_t *panel, bool mirror_x,
  ...
  esp_lcd_panel_io_tx_param(io, LCD_CMD_MADCTL, (uint8_t[]){st7796->madctl_val},
                            1);
  return ESP_OK;
}
