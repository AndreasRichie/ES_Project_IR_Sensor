...
esp_err_t lcd_new_panel_st7789(
...
static const lcd_init_cmd_t vendor_specific_init[] = {
    ...
    {0xd0, {0xa4, 0xa1}, 1},
    {0xe0,
     {0xd0, 0x00, 0x06, 0x09, 0x0b, 0x2a, 0x3c, 0x55, 0x4b, 0x08, 0x16, 0x14,
      0x19, 0x20},
     14},
    {0xe1,
     {0xd0, 0x00, 0x06, 0x09, 0x0b, 0x29, 0x36, 0x54, 0x4b, 0x0d, 0x16, 0x14,
      0x21, 0x20},
     14},
    {0x29, {0}, 0},
    {0, {0}, 0xff},
...
static esp_err_t panel_st7789_draw_bitmap(esp_lcd_panel_t *panel, int x_start,
  ...
  size_t len =
      (x_end - x_start) * (y_end - y_start) * st7789->bits_per_pixel / 8;
...
static esp_err_t panel_st7789_mirror(esp_lcd_panel_t *panel, bool mirror_x,
  ...
  esp_lcd_panel_io_tx_param(io, LCD_CMD_MADCTL, (uint8_t[]){st7789->madctl_val},
                            1);
  return ESP_OK;
}
